...
#define MSS MPI_STATUS_SIZE
  implicit none
!
  integer(kind=4) :: i,j,k, ii,jj, ieb
...
!-------------------- 
      do ieb=0,nebfld
        psd = ieb*2 + ps
        aj(JX:JZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,2+ps) &
       &  = aj(JX:JZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,2+ps) &
       &  + mp(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,ps) &
       &   *eb(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,psd)
!        do k=0,zu-zl
!        do j=0,yu-yl
!        do i=0,xu-xl
!          aj(JX,i,j,k,(nebfld-1)*2+ps) = aj(JX,i,j,k,(nebfld-1)*2+ps) &
!         &                             + mp(EX,i,j,k,ps)*eb(EX,i,j,k,psd)
!          aj(JY,i,j,k,(nebfld-1)*2+ps) = aj(JY,i,j,k,(nebfld-1)*2+ps) &
!         &                             + mp(EY,i,j,k,ps)*eb(EY,i,j,k,psd)
!          aj(JZ,i,j,k,(nebfld-1)*2+ps) = aj(JZ,i,j,k,(nebfld-1)*2+ps) &
!         &                             + mp(EZ,i,j,k,ps)*eb(EZ,i,j,k,psd)
!        end do
!        end do
!        end do
      end do
...
!-------------------- 
      eb(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,(nebfld-1)*2+ps) &
     &  = eb(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,(nebfld-1)*2+ps) &
     &  - aj(JX:JZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,2+ps)! &
!     &  - mp(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,ps) &
!     &   *eb(EX:EZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,nebfld*2+ps)
      aj(JX:JZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,2+ps) &
     &  = aj(JX:JZ,-1:xu-xl+1,-1:yu-yl+1,-1:zu-zl+1,2+ps)*0.5d0
!      do k=0,zu-zl
!      do j=0,yu-yl
!      do i=0,xu-xl
!        eb(EX,i,j,k,(nebfld-1)*2+ps) = eb(EX,i,j,k,(nebfld-1)*2+ps) &
!       &                             - aj(JX,i,j,k,(nebfld-1)*2+ps)
!        eb(EY,i,j,k,(nebfld-1)*2+ps) = eb(EY,i,j,k,(nebfld-1)*2+ps) &
!       &                             - aj(JY,i,j,k,(nebfld-1)*2+ps)
!        eb(EZ,i,j,k,(nebfld-1)*2+ps) = eb(EZ,i,j,k,(nebfld-1)*2+ps) &
!       &                             - aj(JZ,i,j,k,(nebfld-1)*2+ps)
!      end do
!      end do
!      end do
