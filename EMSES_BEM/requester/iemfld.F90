...
!       ------------- gather in x-dir
        call MPI_Allgatherv(dbs(1,0,-1,-1,1),siu+1,mptype_yz(1,2), &
       &                    dbs(1,0,-1,-1,2),rcnts,slcs(:,1),mptype_yz(1,2), &
       &                    subcomm,mpierr)
        dbs(:,:,:,:,1) = 0.0d0
!       ------------- FFT-x
        do k=0,nz
...
!       ------------- gather in z-dir
        call MPI_Allgatherv(dbs(1,-1,-1,0,1),sku+1,mptype_xy(1,2), &
       &                    dbs(1,-1,-1,0,2),rcnts,slcs(:,1),mptype_xy(1,2), &
       &                    subcomm,mpierr)
!       ------------- FFT-z
        do j=0,ny
        do i=0,nx
...
!
       ...
       &                  mptype_xy(1,2),uslice(1),stag, &
       &                  dbs(1,-1,-1,-1,1),1, &
       &                  mptype_xy(1,2),lslice(1),rtag, &
       &                  subcomm, MPI_STATUS_IGNORE, mpierr)
        call MPI_sendrecv(dbs(1,-1,-1,0,1),1, &
       &                  mptype_xy(1,2),lslice(1),stag, &
       &                  dbs(1,-1,-1,szu-szl,1),1, &
       &                  mptype_xy(1,2),uslice(1),rtag, &
       &                  subcomm, MPI_STATUS_IGNORE, mpierr)
!
!     --------------- 
      else if(pftmode.eq.2) then
...
!
       ...
       &                  mptype_xz(1,2),uslice(1),stag, &
       &                  dbs(1,-1,-1,-1,1),1, &
       &                  mptype_xz(1,2),lslice(1),rtag, &
       &                  subcomm, MPI_STATUS_IGNORE, mpierr)
        call MPI_sendrecv(dbs(1,-1,0,-1,1),1, &
       &                  mptype_xz(1,2),lslice(1),stag, &
       &                  dbs(1,-1,syu-syl,-1,1),1, &
       &                  mptype_xz(1,2),uslice(1),rtag, &
       &                  subcomm, MPI_STATUS_IGNORE, mpierr)
!
!     --------------- 
      else if(pftmode.eq.3) then
