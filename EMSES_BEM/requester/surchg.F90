...
!       &                    diff,ncpmxs,scpmxs,MPI_REAL8,MCW,ierr)
        wok(:) = diff(:)
        call MPI_Allreduce(wok,diff,ncpmx,MPI_REAL8,MPI_SUM,MCW,ierr)
...
!        if(myid.eq.0) print*, "diag@surchg: amx =", amx(1,1),amx(2,1),amx(1,2),amx(2,2)
!        if(myid.eq.0) print*, "diag@surchg: apmx =", apmx(1,1),apmx(2,1),apmx(1,2),apmx(2,2)
!        if(myid.eq.0) print*, "diag@surchg: bcmx =", bcmx(1,1),bcmx(2,1),bcmx(1,2),bcmx(2,2)
        if(npcg.eq.1) then
...
!-------------------- surface charge modification
        ...
        if(abs(modeww).eq.2) then
          ...
          wok(:) = sfrho(:)
          call MPI_Allreduce(wok,sfrho,ncpmx,MPI_REAL8,MPI_SUM,MCW,ierr)
...
!             ------- distribute charge with weight
              ...
              rhobk(1,i ,j ,k1,1) = rhobk(1,i ,j ,k1,1) + v1*sfrho(icap)
              rhobk(1,i1,j ,k1,1) = rhobk(1,i1,j ,k1,1) + v2*sfrho(icap)
              rhobk(1,i1,j1,k1,1) = rhobk(1,i1,j1,k1,1) + v3*sfrho(icap)
              rhobk(1,i ,j1,k1,1) = rhobk(1,i ,j1,k1,1) + v4*sfrho(icap)
              rhobk(1,i ,j ,k ,1) = rhobk(1,i ,j ,k ,1) + v5*sfrho(icap)
              rhobk(1,i1,j ,k ,1) = rhobk(1,i1,j ,k ,1) + v6*sfrho(icap)
              rhobk(1,i1,j1,k ,1) = rhobk(1,i1,j1,k ,1) + v7*sfrho(icap)
              rhobk(1,i ,j1,k ,1) = rhobk(1,i ,j1,k ,1) + v8*sfrho(icap)

              rhobk(2,i ,j ,k1,1) = rhobk(2,i ,j ,k1,1) + v1*sfrho(icap)
              rhobk(2,i1,j ,k1,1) = rhobk(2,i1,j ,k1,1) + v2*sfrho(icap)
              rhobk(2,i1,j1,k1,1) = rhobk(2,i1,j1,k1,1) + v3*sfrho(icap)
              rhobk(2,i ,j1,k1,1) = rhobk(2,i ,j1,k1,1) + v4*sfrho(icap)
              rhobk(2,i ,j ,k ,1) = rhobk(2,i ,j ,k ,1) + v5*sfrho(icap)
              rhobk(2,i1,j ,k ,1) = rhobk(2,i1,j ,k ,1) + v6*sfrho(icap)
              rhobk(2,i1,j1,k ,1) = rhobk(2,i1,j1,k ,1) + v7*sfrho(icap)
              rhobk(2,i ,j1,k ,1) = rhobk(2,i ,j1,k ,1) + v8*sfrho(icap)
              ...
              rhobk(2,i ,j ,k1,3) = rhobk(2,i ,j ,k1,3) + v1*sfrho(icap)
              rhobk(2,i1,j ,k1,3) = rhobk(2,i1,j ,k1,3) + v2*sfrho(icap)
              rhobk(2,i1,j1,k1,3) = rhobk(2,i1,j1,k1,3) + v3*sfrho(icap)
              rhobk(2,i ,j1,k1,3) = rhobk(2,i ,j1,k1,3) + v4*sfrho(icap)
              rhobk(2,i ,j ,k ,3) = rhobk(2,i ,j ,k ,3) + v5*sfrho(icap)
              rhobk(2,i1,j ,k ,3) = rhobk(2,i1,j ,k ,3) + v6*sfrho(icap)
              rhobk(2,i1,j1,k ,3) = rhobk(2,i1,j1,k ,3) + v7*sfrho(icap)
              rhobk(2,i ,j1,k ,3) = rhobk(2,i ,j1,k ,3) + v8*sfrho(icap)
